          ...
          {filtered.map((img) => (
            ...
            >
              ...
              <div className="absolute top-3 right-3 z-10 opacity-0 group-hover:opacity-100 transition-opacity">
                <span className="px-2 py-1 bg-forest-dark/70 backdrop-blur text-cream text-[10px] rounded-full uppercase tracking-wider">
                  Bekijk
                </span>
              </div>
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-5 z-10 flex items-end justify-between">
                ...
                <span className="w-8 h-8 rounded-full bg-white/15 backdrop-blur flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
